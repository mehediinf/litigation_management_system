...
import 'case_filling_action/case_filling_action_approve_reassign_page.dart';
import 'case_filling_action/case_filling_action_delete_page.dart';
import 'case_filling_action/case_filling_action_edit_page.dart';
import 'case_filling_action/case_filling_action_preview_page.dart';
import 'case_filling_action/case_filling_action_reassign_file_page.dart';
import 'case_filling_action/case_filling_action_send_to_checker_page.dart';
import 'case_filling_action/case_filling_action_verify_page.dart';
...
class _CaseGridCardState extends State<_CaseGridCard>
  ...
  static const Map<String, Map<String, Object>> _kActionMeta = {
    ...
    'AR': {'icon': Icons.approval, 'desc': 'Approve Reassign'},
      ...
      case 'D':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => CaseFillingActionDeletePage(caseData: d),
          ),
        );
        return;
      case 'E':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => CaseFillingActionEditPage(caseData: d),
          ),
        );
        return;
      case 'STC':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => CaseFillingActionSendToCheckerPage(caseData: d),
          ),
        );
        return;
      case 'V':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => CaseFillingActionVerifyPage(caseData: d),
          ),
        );
        return;
      case 'RF':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => CaseFillingActionReassignFilePage(caseData: d),
          ),
        );
        return;
      case 'AR':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => CaseFillingActionApproveReassignPage(caseData: d),
          ),
        );
        return;
      case 'P':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => CaseFillingActionPreviewPage(caseData: d),
          ),
        );
        return;
      default:
