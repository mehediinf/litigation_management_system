//lib/features/head_office/supreme_court_matter/presentation/views/billing.dart

import 'package:flutter/material.dart';
import 'package:dropdown_search/dropdown_search.dart';

import 'billing_action/billing_action_approve_reassign_page.dart';
import 'billing_action/billing_action_delete_page.dart';
import 'billing_action/billing_action_edit_page.dart';
import 'billing_action/billing_action_preview_page.dart';
import 'billing_action/billing_action_reassign_file_page.dart';
import 'billing_action/billing_action_send_to_checker_page.dart';
import 'billing_action/billing_action_verify_page.dart';
      ...
      case 'D':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => BillingActionDeletePage(caseData: d),
          ),
        );
        return;
      case 'E':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => BillingActionEditPage(caseData: d),
          ),
        );
        return;
      case 'STC':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => BillingActionSendToCheckerPage(caseData: d),
          ),
        );
        return;
      case 'V':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => BillingActionVerifyPage(caseData: d),
          ),
        );
        return;
      case 'P':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => BillingActionPreviewPage(caseData: d),
          ),
        );
        return;
      default:
