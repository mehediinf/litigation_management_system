//lib/features/legal_team/appeal_and_bail_money/presentation/views/appeal_hearing_bill.dart

import 'package:flutter/material.dart';
import 'package:dropdown_search/dropdown_search.dart';

import 'hearing_bill/hearing_bill_action_delete_page.dart';
import 'hearing_bill/hearing_bill_action_edit_page.dart';
import 'hearing_bill/hearing_bill_action_preview_page.dart';
import 'hearing_bill/hearing_bill_action_send_to_checker_page.dart';
import 'hearing_bill/hearing_bill_action_verify_page.dart';

class AppealHearingBillPage extends StatefulWidget {
  const AppealHearingBillPage({super.key});

  @override
  State<AppealHearingBillPage> createState() => _AppealHearingBillPageState();
}

class _AppealHearingBillPageState extends State<AppealHearingBillPage>
  ...
  final TextEditingController _accountNameSearchController =
  ...
  void dispose() {
    ...
    _accountNameSearchController.dispose();
  ...
  void _showAdvancedSearchDialog() {
    showDialog(
      ...
      builder: (context) => _AdvancedSearchDialog(
        ...
        initialAccountName: _accountNameSearchController.text,
        onSearch:
            (
              caseType,
              proposedType,
              ...
              setState(() {
                ...
                _accountNameSearchController.text = serialNo;
              });
  ...
  void _openActionByCode(BuildContext context, String code) {
    ...
    switch (code) {
      case 'D':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => HearingBillActionDeletePage(caseData: d),
          ),
        );
        return;
      case 'E':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => HearingBillActionEditPage(caseData: d),
          ),
        );
        return;
      case 'STC':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => HearingBillActionSendToCheckerPage(caseData: d),
          ),
        );
        return;
      case 'V':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => HearingBillActionVerifyPage(caseData: d),
          ),
        );
        return;
      ...
      case 'P':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => HearingBillActionPreviewPage(caseData: d),
          ),
        );
        return;
