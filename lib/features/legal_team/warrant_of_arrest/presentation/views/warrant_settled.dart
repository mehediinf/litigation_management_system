...
class _ComplianceCaseCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final String status = _v('Status');
    final bool isSettled = status.toLowerCase().contains('settle');

    final Color accentColor = isSettled
...
final List<Map<String, dynamic>> _dummyComplianceCases = [
  {
    ...
    'Amount': '1238031.92',
    'Borrower Name': 'Nur Nahar',
  },
  {
    'Status': 'Setteled',
    'Account Name': 'M/S Bilkis Enterprise',
    'Account': '0201604534100001',
    'Type': 'Loan',
    'CMA Serial No': '',
    'Case Name': 'Arthorin Adalat Ain-2003',
    'Case Number': 'Artho-23/22',
    'Amount': '417656.45',
    'Borrower Name': '',
  },
  {
    'Status': 'Setteled',
    'Account Name': 'M/S Akbar Enterprize',
    'Account': '0501600072651001',
    'Type': 'Loan',
    'CMA Serial No': '',
    'Case Name': 'Arthorin Adalat Ain-2003',
