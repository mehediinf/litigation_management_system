...
class BulkRFPage extends StatefulWidget {
  const BulkRFPage({super.key});

  @override
  State<BulkRFPage> createState() => _BulkRFPageState();
}

class _BulkRFPageState extends State<BulkRFPage> {
