...
import 'all_bulk_action/bulk_authorization_request.dart';
import 'all_bulk_action/bulk_send_for_approval.dart';
import 'authorization_request/authorization_memo_page.dart';
import 'authorization_request/delete_page.dart';
import 'authorization_request/edit_page.dart';
import 'authorization_request/legal_menager_authorization_page.dart';
import 'authorization_request/preview_page.dart';
import 'authorization_request/send_for_authorization_page.dart';

class CaseManagementAuthorizationRequestPage extends StatefulWidget {
  const CaseManagementAuthorizationRequestPage({super.key});

  @override
  State<CaseManagementAuthorizationRequestPage> createState() =>
      _CaseManagementAuthorizationRequestPageState();
}

class _CaseManagementAuthorizationRequestPageState
    extends State<CaseManagementAuthorizationRequestPage>
            ...
            children: [
              ...
              _BulkActionButton(
                ...
                onPressed: () {
                  ...
                  Navigator.of(context).push<void>(
                    MaterialPageRoute<void>(
                      builder: (_) => const BulkSendForApprovalPage(),
                    ),
                  );
                },
              ),
              ...
              OutlinedButton.icon(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          const BulkAuthorizationRequestPage(),
                    ),
                  );
                },
                icon: const Icon(
...
class _CaseGridCardState extends State<_CaseGridCard>
  ...
  static const Map<String, Map<String, Object>> _kActionMeta = {
    ...
    'SFA': {'icon': Icons.fact_check, 'desc': 'Send For Authorization'},
    'LMA': {
      'icon': Icons.assignment_return,
      'desc': 'Legal Manager Authorization',
    },
    'AM': {'icon': Icons.check_circle_rounded, 'desc': 'Authorization Memo'},
  ...
  void _openActionByCode(BuildContext context, String code) {
    ...
    switch (code) {
      case 'D':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(builder: (_) => DeletePage(caseData: d)),
        );
        return;
      case 'E':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(builder: (_) => EditPage(caseData: d)),
        );
        return;
      case 'SFA':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => SendForAuthorizationPage(caseData: d),
          ),
        );
        return;
      case 'LMA':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => LegalManagerAuthorizationPage(caseData: d),
          ),
        );
        return;
      ...
      case 'AM':
        Navigator.of(context).push<void>(
          MaterialPageRoute<void>(
            builder: (_) => AuthorizationMemoPage(caseData: d),
          ),
        );
        return;
      case 'P':
...
final List<Map<String, dynamic>> _dummyCases = [
  {
    'Actions': ['D', 'E', 'SFA', 'LMA', 'AM', 'P'],
    'Type': 'Withdraw',
    'Status': 'Authorized By Legal Manager',
    'Req. Type': 'ARA-2003',
    'Loan A/C or Card No.': '1513203983155001',
    'A/C Name or Name on Card': 'Tamhid Packaging Industries',
    'Entry By': 'Super Admin3 (5555555)',
    'Entry Date Time': '31-Oct-22 06:24 PM',
    'Update By': 'Super Admin2 (6666666)',
    'Update Date and Time': '31-Oct-22 06:24 PM',
  },
