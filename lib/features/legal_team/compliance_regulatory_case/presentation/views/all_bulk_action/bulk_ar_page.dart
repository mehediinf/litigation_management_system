...
class BulkARPage extends StatefulWidget {
  const BulkARPage({super.key});

  @override
  State<BulkARPage> createState() => _BulkARPageState();
}

class _BulkARPageState extends State<BulkARPage> {
