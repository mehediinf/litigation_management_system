...
class CaseStatusBulkApprovePage extends StatefulWidget {
  const CaseStatusBulkApprovePage({super.key});

  @override
  State<CaseStatusBulkApprovePage> createState() =>
      _CaseStatusBulkApprovePageState();
}

class _CaseStatusBulkApprovePageState extends State<CaseStatusBulkApprovePage> {
