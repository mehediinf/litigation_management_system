    ...
    final facilities = [
      {
        ...
        'balance': '',
        'balanceDate': '',
        'schDesc': 'APURBO LOAN - EMI - SME',
        'rate': '3.00',
        'disburseDate': '28-Sep-18',
        'disburseAmt': '800000.00',
        'expireDate': '31-Dec-01',
        'tenour': '2',
        'payable': '0.00',
        'repayment': '0.00',
        'outBalance': '12.00',
        'outBalanceDate': '28-Sep-14',
    ...
    return _horizontalListSectionSlivers(
      ...
      itemBuilder: (context, index) {
        ...
        return _buildNestedCard(
          ...
          title: '${f['type']} - ${f['ac']}',
          details: [
            _DetailItem('A/C Name', '${f['name']}'),
            _DetailItem('Balance', '${f['balance']}'),
            _DetailItem('Balance Date', '${f['balanceDate']}'),
            _DetailItem('Sch Desc.', '${f['schDesc']}'),
            _DetailItem('Int. Rate', '${f['rate']}%'),
            _DetailItem('Disbursement Date', '${f['disburseDate']}'),
            _DetailItem('Disbursed Amount', '${f['disburseAmt']}'),
            _DetailItem('Expire Date', '${f['expireDate']}'),
            _DetailItem('Tenour', '${f['tenour']}'),
            _DetailItem('Payable', '${f['payable']}'),
            _DetailItem('Repayment', '${f['repayment']}'),
            _DetailItem('Out. Balance', '${f['outBalance']}'),
            _DetailItem('Out. Bal. Date', '${f['outBalanceDate']}'),
            _DetailItem('Overdue Balance', '${f['overdueBalance']}'),
            _DetailItem('Overdue BL Date', '${f['overdueBlDate']}'),
            _DetailItem('Call-up Date', '${f['callUpDate']}'),
            _DetailItem('Write-off Date', '${f['writeOffDate']}'),
            _DetailItem('Write-off Amt', '${f['writeOffAmt']}'),
            _DetailItem('Recovery After WO', '${f['recovery']}'),
            _DetailItem('CL(BB)', '${f['clBB']}', isStatus: true),
            _DetailItem('CL(BBL)', '${f['clBBL']}', isStatus: true),
          ],
        );
      },
    );
      ...
      itemBuilder: (context, index) {
        ...
        return _buildNestedCard(
          ...
          details: [
            ...
            _DetailItem('Thana', '${s['thana']}'),
            _DetailItem('Sub Reg Office', '${s['sub_reg']}'),
            _DetailItem('Mouza', '${s['mouza']}'),
            _DetailItem('Land Area', '${s['area']}'),
            _DetailItem('Plot Number', '${s['plot']}'),
            _DetailItem('Holding number', '${s['holding']}'),
            _DetailItem('Jote No.', '${s['jote']}'),
            _DetailItem('CS Khatian no.', '${s['cs_khatian']}'),
            _DetailItem('SA/PS Khatian no.', '${s['sa_khatian']}'),
            _DetailItem('RS/MRR Khatian no.', '${s['rs_khatian']}'),
            _DetailItem('BS/DP/ROR Khatian no.', '${s['bs_khatian']}'),
            _DetailItem('City Jorip Khatian no.', '${s['city_khatian']}'),
            _DetailItem('Mutation Khatian no.', '${s['mutation_khatian']}'),
            _DetailItem('CS Dag no.', '${s['cs_dag']}'),
            _DetailItem('SA Dag no.', '${s['sa_dag']}'),
            _DetailItem('RS Dag no.', '${s['rs_dag']}'),
            _DetailItem('BS/DP Dag no.', '${s['bs_dag']}'),
            _DetailItem('City Jorip Dag no.', '${s['city_dag']}'),
          ],
        );
      },
    );
    ...
    return _horizontalListSectionSlivers(
      ...
      itemBuilder: (context, index) {
        ...
        return _buildNestedCard(
          ...
          details: [
            _DetailItem('Schedule Desc', '${m['desc']}'),
            _DetailItem('Deed Number', '${m['deed']}'),
            _DetailItem('Mortgage Date', '${m['date']}'),
            _DetailItem('Valuator Name', '${m['valuator']}'),
            _DetailItem('Valuator Date', '${m['v_date']}'),
            _DetailItem('Valuator MV', '${m['mv']}'),
            _DetailItem('Valuator FSV', '${m['fsv']}'),
            _DetailItem('Re-Valuator', '${m['revaluator']}'),
            _DetailItem('Re-Valuator Date', '${m['rv_date']}'),
            _DetailItem('Re-Valuator MV', '${m['rv_mv']}'),
            _DetailItem('Re-Valuator FSV', '${m['rv_fsv']}'),
            _DetailItem('Gov\'t Mouza Rate', '${m['mouza_rate']}'),
            _DetailItem('Total Land Area', '${m['area']}'),
