// lib/features/dashboard/presentation/views/live_case_information/live_case_information_preview.dart
...
class LiveCaseInformationPreview extends StatelessWidget {
  const LiveCaseInformationPreview({super.key, required this.sectionTitle});
